...
d("#monthly").text(b.currencySign+h.earnings.avgmonthly.earnings);d("#avgpercust").text(b.currencySign+h.earnings.avgpercust.total);d("#avgpercust-compare span").text(h.earnings.avgpercust.compare.percentage+g).removeClass().addClass(h.earnings.avgpercust.compare.classes);
...
d("#subscriptions").text(h.subscriptions.count);d(".detail-compare-first").text(b.currencySign+h.earnings.compare.total);d("#box-4 .bottom-text span").text(h.earnings.compare.percentage+"%");
