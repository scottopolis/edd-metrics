...
d("#discounts").text(h.discounts);d(".detail-compare-first").text(b.currencySign+h.earnings.compare.total);d("#box-4 .bottom-text span").text(h.earnings.compare.percentage+"%");
