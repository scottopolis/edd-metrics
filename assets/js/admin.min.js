...
}};b.dashResponse=function(f){console.log(f);var h=JSON.parse(f);var g="% over previous "+h.dates.num_days+" days";d("#revenue").text(b.currencySign+h.earnings.total);
...
};b.detailResponse=function(f){console.log("detailResponse",f);var i=JSON.parse(f);var h=b.getQueryVariable("metric");var g="% compared to this period";
