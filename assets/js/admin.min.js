...
var h=JSON.parse(f);console.log(h);var g="% over the last "+h.dates.num_days+" days";d("#revenue").text("$"+h.earnings.total);d("#revenue-compare span").text(h.earnings.compare.percentage+g).removeClass().addClass(h.earnings.compare.classes);
...
d("#refunds").text(h.refunds.count);};jQuery(a).ready(b.init);})(window,document,jQuery);