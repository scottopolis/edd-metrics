...
d("#earnings-this-month h2").text(b.currencySign+i.earnings.detail.this_month);d("#monthly h2").text(b.currencySign+i.earnings.avgmonthly.earnings);d("#new-customers h2").text(i.earnings.avgpercust.current_customers);
d("#new-customers span").text("This period");d("#renewal-rate h2").text(i.yearly_renewal_rate.percent+"%");d("#yearly-renewal-compare span").text("Last "+i.yearly_renewal_rate.period+" days");
